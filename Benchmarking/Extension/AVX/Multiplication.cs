...
{
    public class Multiplication : BaseAvx
    {
            ...
            unsafe
            {
                ...
                fixed (float* psrc = randomFloatingSpan)
                {
                    ...
                    while (!cancellationToken.IsCancellationRequested)
                    {
                        ...
                        {
                            dstVector = Avx.Multiply(dstVector, srcVector);
                        }
        ...
        {
            return "AVX benchmark of multiplication on 256-bit floats (8 floating numbers)";
        }
        ...
        {
            return new[] {"extension", "avx", "multiplication", "all"};
        }
    }
}