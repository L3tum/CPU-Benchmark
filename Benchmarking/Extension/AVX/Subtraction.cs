...
{
    public class Subtraction : BaseAvx
    {
            ...
            unsafe
            {
                ...
                fixed (float* psrc = randomFloatingSpan)
                {
                    ...
                    while (!cancellationToken.IsCancellationRequested)
                    {
                        ...
                        {
                            dstVector = Avx.Subtract(dstVector, srcVector);
                        }
        ...
        {
            return "AVX benchmark of subtraction on 256-bit floats (8 floating numbers)";
        }
        ...
        {
            return new[] {"extension", "avx", "subtraction", "all"};
        }
    }
}