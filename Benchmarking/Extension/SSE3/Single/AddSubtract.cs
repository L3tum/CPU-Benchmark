...
{
    public class AddSubtract : BaseSse3
    {
            ...
            unsafe
            {
                ...
                fixed (float* psrc = randomFloatingSpan)
                {
                    ...
                    while (!cancellationToken.IsCancellationRequested)
                    {
                        ...
                        {
                            dstVector = Sse3.AddSubtract(dstVector, srcVector);
                        }
        ...
        {
            return "SSE3 benchmark of addition-subtraction on 128-bit floats (4 numbers)";
        }
        ...
        {
            return "sse3_addsub_single";
        }

        public override string[] GetCategories()
        {
            return new[] {"extension", "sse3", "addsub", "all"};
        }
    }
}