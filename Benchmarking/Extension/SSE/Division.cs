...
namespace Benchmarking.Extension.SSE
{
    public class Division : BaseSse
    {
            ...
            unsafe
            {
                ...
                fixed (float* psrc = randomFloatingSpan)
                {
                    ...
                    while (!cancellationToken.IsCancellationRequested)
                    {
                        ...
                        {
                            dstVector = Sse.Divide(dstVector, srcVector);
                        }
        ...
        {
            return "SSE benchmark of division on 128-bit floats (4 floating numbers)";
        }
        ...
        {
            return new[] {"extension", "sse", "division", "all"};
        }
    }
}