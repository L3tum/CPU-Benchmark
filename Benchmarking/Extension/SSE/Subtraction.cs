...
{
    public class Subtraction : BaseSse
    {
        public override ulong Run(CancellationToken cancellationToken)
        {
            ...
            var dst = new Span<float>(Enumerable.Repeat(float.MaxValue, 4).ToArray());
            var iterations = 0uL;
            ...
            unsafe
            {
                ...
                fixed (float* psrc = randomFloatingSpan)
                {
                    ...
                    while (!cancellationToken.IsCancellationRequested)
                    {
                        ...
                        {
                            dstVector = Sse.Subtract(dstVector, srcVector);
                        }
        ...
        {
            return "SSE benchmark of subtraction on 128-bit floats (4 floating numbers)";
        }
        ...
        {
            return new[] {"extension", "sse", "subtraction", "all"};
        }
    }
}